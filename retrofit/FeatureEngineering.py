...
class FeatureEngineering:
    ...
    # def FE1_AutoCalendarVariables(self, data = None, ArgsList = None, DateColumnNames = None, CalendarVariables = None, use_saved_args = False):
    #     raise NotImplementedError


class PolarsFe(FeatureEngineering):
    """Feature Engineering functions for use with the Polars library"""
