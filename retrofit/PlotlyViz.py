...
def ScatterPlot(data=None,
    ...
    # Return plot object
    return fig
px.line(data_frame= , x=, y=, line_group=, color=, line_dash=,symbol=,hover_name=,hover_data=,custom_data=,text=,facet_row=,facet_col=,facet_col_wrap=,facet_row_spacing=,facet_col_spacing=,error_x=,error_x_minus=,error_y=,error_y_minus=,animation_frame=,animation_group=,category_orders=,labels=,orientation=,color_discrete_sequence=,color_discrete_map=,line_dash_sequence=,line_dash_map=,symbol_sequence=,symbol_map=,markers=,log_x=
,log_x=,log_y=,range_x=,range_y=,line_shape=,render_mode=,title=,template=,width=,height=)

px.line()
def LinePlot(data=None,range_y= 
                Title=None,
                N=100000,
                XVar=None,
                YVar=None, 
